...
export function AssessmentInitiatorEnhanced({ systemId, onAssessmentStarted }: AssessmentInitiatorProps) {
  ...
  return (
    <div className="space-y-6" data-testid="assessment-initiator-enhanced">
