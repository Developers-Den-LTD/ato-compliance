#!/usr/bin/env node
/**
 * STIG-to-NIST Control Mapping Initialization Script (JavaScript version)
...
const { db } = require('../db');
const { ccis, stigRuleControls, stigRules, controls } = require('../../shared/schema');
...
module.exports = { initializeStigMappings };